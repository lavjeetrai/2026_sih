    ...
    <div className="space-y-2.5">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <Button
          ...
          className="w-full text-xs font-semibold py-2 h-auto bg-neutral-50 hover:bg-blue-50/70 hover:border-blue-300 text-neutral-800 border-neutral-200/90 rounded-lg transition-all cursor-pointer shadow-2xs"
        >
          <Briefcase className="mr-1.5 h-3.5 w-3.5 text-blue-600 shrink-0" />
          <span className="truncate">Demo Manager</span>
        </Button>
        <Button
          type="button"
          variant="outline"
          onClick={() => onQuickLogin?.("lav@gmail.com")}
          className="w-full text-xs font-semibold py-2 h-auto bg-neutral-50 hover:bg-emerald-50/70 hover:border-emerald-300 text-neutral-800 border-neutral-200/90 rounded-lg transition-all cursor-pointer shadow-2xs"
        >
          <User className="mr-1.5 h-3.5 w-3.5 text-emerald-600 shrink-0" />
          <span className="truncate">Demo Field Officer</span>
        </Button>
      </div>
    </div>
  );
...
function AuthSignIn({ onForgotPassword, onSignUp, onLoginSuccess, defaultRole = "worker" }: AuthSignInProps) {
  ...
  const handleQuickFill = (email: string) => {
    ...
    if (email.includes("priyanka") || email.includes("manager")) {
